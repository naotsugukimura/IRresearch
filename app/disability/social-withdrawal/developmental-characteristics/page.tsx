...
export default function DevelopmentalCharacteristicsPage() {
  const data = getDisabilitySubType("social-withdrawal", "developmental-characteristics");
        ...
        <div className="sticky top-0 z-20 border-b border-border bg-background/95 px-4 py-3 backdrop-blur md:px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <PageHeader
                title={data.name}
                description={`社会的ひきこもり > ${data.name}`}
              />
            </div>
          </div>
        </div>
