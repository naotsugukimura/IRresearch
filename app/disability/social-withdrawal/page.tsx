...
export default function SocialWithdrawalPage() {
  const data = getDisabilityCategory("social-withdrawal");
  if (!data) return notFound();
  const subTypeData = getDisabilitySubTypes("social-withdrawal");
