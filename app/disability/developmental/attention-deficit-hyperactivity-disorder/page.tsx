...
export default function AttentionDeficitHyperactivityDisorderPage() {
  const data = getDisabilitySubType("developmental", "attention-deficit-hyperactivity-disorder");
