...
export default function MedicalCareChildPage() {
  const data = getDisabilityCategory("medical-care-child");
  if (!data) return notFound();
  const subTypeData = getDisabilitySubTypes("medical-care-child");
