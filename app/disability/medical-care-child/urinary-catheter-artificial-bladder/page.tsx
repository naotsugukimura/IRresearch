...
export default function UrinaryCatheterArtificialBladderPage() {
  const data = getDisabilitySubType("medical-care-child", "urinary-catheter-artificial-bladder");
