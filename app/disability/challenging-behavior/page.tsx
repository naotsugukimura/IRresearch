...
export default function ChallengingBehaviorPage() {
  const data = getDisabilityCategory("challenging-behavior");
  if (!data) return notFound();
  const subTypeData = getDisabilitySubTypes("challenging-behavior");
