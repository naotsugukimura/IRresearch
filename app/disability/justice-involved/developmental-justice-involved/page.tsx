...
export default function DevelopmentalJusticeInvolvedPage() {
  const data = getDisabilitySubType("justice-involved", "developmental-justice-involved");
